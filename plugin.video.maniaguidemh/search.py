...
f = xbmcvfs.File('special://profile/addon_data/plugin.video.maniaguidemh/favourites.xml')
data = f.read()
f.close()
if not data:
    f = xbmcvfs.File('special://home/addons/plugin.video.maniaguidemh/resources/favourites.xml')
    data = f.read()
    f.close()
