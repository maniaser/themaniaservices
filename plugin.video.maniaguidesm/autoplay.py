...
class Autoplay(object):
    ...
    def _scheduleAutoplay(self, channelId, programTitle, startTime, endTime):
        ...
        xbmc.executebuiltin('AlarmClock(%s-start,RunScript(special://home/addons/plugin.video.maniaguidesm/play.py,%s,%s),%d,True)' %
        ...
        if ADDON.getSetting('autoplays.stop') == 'true':
            xbmc.executebuiltin('AlarmClock(%s-stop,RunScript(special://home/addons/plugin.video.maniaguidesm/stop.py,%s,%s),%d,True)' %
