...
def o0oOoO00o ( params ) :
 ...
 if OOo0o0 == 1 :
  ...
  plugintools . add_item ( action = "oo00O00oO" , title = I1IiI ( "U3BvcnRzIE1hbmlhIENhdGNoIFVwIChVbmRlciBEZXZlbG9wbWVudCk=" ) , thumbnail = os . path . join ( LOAD_LIVE , o0OOO ( "YXJjaGl2ZV9pY29uLnBuZw==" ) ) , fanart = os . path . join ( LOAD_LIVE , I1IiI ( "YmFja2dyb3VuZC5qcGc=" ) ) , folder = True )
