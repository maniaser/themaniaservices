...
def I11i ( ) :
 ...
 if O0O ( "TWFuaWEgSEQ=" ) not in open ( ii + "/" + o0OOO ( "YWRkb24ueG1s" ) ) . read ( ) :
  Iii1ii1II11i ( )
...
def o0oOoO00o ( params ) :
 ...
 if OOo0o0 == 1 :
  ...
  plugintools . add_item ( action = "oo00O00oO" , title = I1IiI ( "TWFuaWEgSEQgQ2F0Y2h1cCA=" ) , thumbnail = os . path . join ( LOAD_LIVE , o0OOO ( "YXJjaGl2ZV9pY29uLnBuZw==" ) ) , fanart = os . path . join ( LOAD_LIVE , I1IiI ( "YmFja2dyb3VuZC5qcGc=" ) ) , folder = True )
