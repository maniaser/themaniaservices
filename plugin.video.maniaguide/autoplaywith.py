...
class Autoplaywith(object):
    ...
    def _scheduleAutoplaywith(self, channelId, programTitle, startTime, endTime):
        ...
        xbmc.executebuiltin('AlarmClock(%s-start,RunScript(special://home/addons/plugin.video.maniaguide/playwith.py,%s,%s),%d,True)' %
        ...
        if ADDON.getSetting('autoplaywiths.stop') == 'true':
            xbmc.executebuiltin('AlarmClock(%s-stop,RunScript(special://home/addons/plugin.video.maniaguide/stopwith.py,%s,%s),%d,True)' %
