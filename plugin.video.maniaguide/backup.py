...
def getCustomStreamUrls(success):
    if success:
        ...
        file_name = 'special://profile/addon_data/plugin.video.maniaguide/custom_stream_urls.ini'
...
def getAltCustomStreamUrls(success):
    if success:
        ...
        file_name = 'special://profile/addon_data/plugin.video.maniaguide/alt_custom_stream_urls.tsv'
        f = xbmcvfs.File(file_name,'wb')
