...
def getCustomStreamUrls(success):
    if success:
        ...
        file_name = 'special://profile/addon_data/plugin.video.maniaguidesm/custom_stream_urls.ini'
...
def getAltCustomStreamUrls(success):
    if success:
        ...
        file_name = 'special://profile/addon_data/plugin.video.maniaguidesm/alt_custom_stream_urls.tsv'
        f = xbmcvfs.File(file_name,'wb')
