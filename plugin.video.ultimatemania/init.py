...
def o0oOoO00o ( params ) :
 ...
 if OOo0o0 == 1 :
  ...
  plugintools . add_item ( action = "oo00O00oO" , title = I1IiI ( "VWx0aW1hdGUgTWFuaWEgQ2F0Y2h1cCAoVW5kZXIgRGV2ZWxvcG1lbnQp" ) , thumbnail = os . path . join ( LOAD_LIVE , o0OOO ( "YXJjaGl2ZV9pY29uLnBuZw==" ) ) , fanart = os . path . join ( LOAD_LIVE , I1IiI ( "YmFja2dyb3VuZC5qcGc=" ) ) , folder = True )
