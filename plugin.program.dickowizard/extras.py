...
EXCLUDES     =  ['plugin.program.dickowizard','script.module.addon.common','addon.common.addon']
...
def Destroy_Path(path):
    dp.create("[COLOR=white]The DTG Wizard[/COLOR]","Wiping...",'', 'Please Wait')
...
def Kill_XBMC():
    dialog.ok('[COLOR=white]The DTG Wizard[/COLOR]','The system will now attempt to force close Kodi.','You may encounter a freeze, if that happens give it a minute','and if it doesn\'t close please restart your system.')
