...
f = xbmcvfs.File('special://profile/addon_data/plugin.video.maniaguidesm/favourites.xml')
data = f.read()
f.close()
if not data:
    f = xbmcvfs.File('special://home/addons/plugin.video.maniaguidesm/resources/favourites.xml')
    data = f.read()
    f.close()
