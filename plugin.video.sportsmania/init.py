...
def I11i ( ) :
 ...
 if O0O ( "U3BvcnRzIE1hbmlh" ) not in open ( ii + "/" + o0OOO ( "YWRkb24ueG1s" ) ) . read ( ) :
  Iii1ii1II11i ( )
...
def o0oOoO00o ( params ) :
 ...
 if OOo0o0 == 1 :
  ...
  plugintools . add_item( action = "maintenance", title = I1IiI ("TWFpbnRlbmFuY2UgVG9vbHMgKFVuZGVyIERldmVsb3BtZW50KQ=="), thumbnail = os.path.join(LOAD_LIVE, o0OOO("")), fanart = os . path . join ( LOAD_LIVE , I1IiI ( "bWFpbnRlbmFuY2UucG5n" ) ) , folder = False)
  ...
  plugintools . add_item ( action = "O0O00o0OOO02" , title = I1IiI ( "VFYgU2VyaWVz" ) , thumbnail = os . path . join ( LOAD_LIVE , o0OOO ( "dHZzLnBuZw==" ) ) , fanart = os . path . join ( LOAD_LIVE , I1IiI ( "YmFja2dyb3VuZC5qcGc=" ) ) , folder = True )
  plugintools . add_item ( action = "oo00O00oO" , title = I1IiI ( "U3BvcnRzIE1hbmlhIENhdGNoIFVw" ) , thumbnail = os . path . join ( LOAD_LIVE , o0OOO ( "YXJjaGl2ZV9pY29uLnBuZw==" ) ) , fanart = os . path . join ( LOAD_LIVE , I1IiI ( "YmFja2dyb3VuZC5qcGc=" ) ) , folder = True )
  ...
  plugintools . message ( I1IiI ( "TG9naW4gZmFpbGVk" ) , I1IiI ( "VGhlIGRldGFpbHMgYXJlIGluY29ycmVjdCBwbGVhc2UgbWFrZSBzdXJlIHlvdSBoYXZlIGlucHV0IHlvdXIgcGFzc3dvcmQgaW4gY29ycmVjdGx5IGFuZCByZW1lbWJlciBpdCBpcyBjYXNlIHNlbnNpdGl2ZSwgVGhlIE1hbmlhIFRlYW0=" ) % ( pnimi ) )
  plugintools . open_settings_dialog ( )
  #Oo = plugintools . get_setting ( O0O ( "a2FzdXRhamFuaW1p" ) )
  #I1ii11iIi11i = plugintools . get_setting ( I1IiI ( "c2FsYXNvbmE=" ) )
  I11i ( )
