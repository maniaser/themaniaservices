...
for path in unique:
    ...
    for file in thumbnails:
        ...
        thumbs[file] = thumb
logo_folder = 'special://profile/addon_data/plugin.video.maniaguide/addon_logos/'
for addonId in sorted(logos):
    folder = 'special://profile/addon_data/plugin.video.maniaguide/addon_logos/%s' % addonId
