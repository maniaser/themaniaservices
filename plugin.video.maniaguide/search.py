...
f = xbmcvfs.File('special://profile/addon_data/plugin.video.maniaguide/favourites.xml')
data = f.read()
f.close()
if not data:
    f = xbmcvfs.File('special://home/addons/plugin.video.maniaguide/resources/favourites.xml')
    data = f.read()
    f.close()
