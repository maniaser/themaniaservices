...
if place == "Local":
    ...
    dirs, files = xbmcvfs.listdir('special://profile/addon_data/plugin.video.maniaguidesm/pick/')
    for f in files:
        path = 'special://profile/addon_data/plugin.video.maniaguidesm/pick/'+f
    ...
    for h in hits:
        ...
        localfile = 'special://profile/addon_data/plugin.video.maniaguidesm/pick/'+basename
    ...
    what = d.browse(2, 'Image', 'files', '', True, False, 'special://profile/addon_data/plugin.video.maniaguidesm/pick/')
