...
def getCommandActions():
    ...
    f = xbmcvfs.File('special://profile/addon_data/plugin.video.maniaguidesm/commands.json','rb')
    j = f.read()
    f.close()
    if j:
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if main_action == 0:
            ...
            f = xbmcvfs.File('special://profile/addon_data/plugin.video.maniaguidesm/commands.json','wb')
